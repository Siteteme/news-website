    ...
    <section className="border border-gray-300 rounded-[10px] overflow-hidden flex flex-col  justify-center flex-wrap">
      ...
      <div className="self-right  ">
        <ul className="flex flex-col items-start justify-center my-2 mx-2">
          <li className="before:content-['->'] transition-all relative before:absolute before:right-0 px-5 text-[12px] odd:bg-[#F9F9F9] w-full py-2 font-medium hover:shadow-md hover:shadow-[#C6DBFF] rounded  hover:text-[#0049C6]  hover:bg-[#C6DBFF] line leading-7">
            <a href="https://www.google.com/">
              راهبردهایی برای رفع ناترازی گاز در ایران
            </a>
          </li>
          <li className="before:content-['->'] transition-all relative before:absolute before:right-0 px-5 text-[12px] odd:bg-[#F9F9F9] w-full py-2 font-medium hover:shadow-md hover:shadow-[#C6DBFF] rounded  hover:text-[#0049C6]  hover:bg-[#C6DBFF] line leading-7">
            <a href="https://www.google.com/">هوشمندسازی مصرف گاز و چند نکته</a>
          </li>
          <li className="before:content-['->'] transition-all relative before:absolute before:right-0 px-5 text-[12px] odd:bg-[#F9F9F9] w-full py-2 font-medium hover:shadow-md hover:shadow-[#C6DBFF] rounded  hover:text-[#0049C6]  hover:bg-[#C6DBFF] line leading-7">
            <a href="https://www.google.com/">
              پالایشگاه در مسیر پتروپالایشی شدن
            </a>
          </li>
          <li className="before:content-['->'] transition-all relative before:absolute before:right-0 px-5 text-[12px] odd:bg-[#F9F9F9] w-full py-2 font-medium hover:shadow-md hover:shadow-[#C6DBFF] rounded  hover:text-[#0049C6]  hover:bg-[#C6DBFF] line leading-7">
            <a href="https://www.google.com/">
          ...
          <li className="before:content-['->'] transition-all relative before:absolute before:right-0 px-5 text-[12px] odd:bg-[#F9F9F9] w-full py-2 font-medium hover:shadow-md hover:shadow-[#C6DBFF] rounded  hover:text-[#0049C6]  hover:bg-[#C6DBFF] line leading-7">
            <a href="https://www.google.com/">چرا ایران واردکننده بنزین شد؟</a>
          </li>
          <li className="before:content-['->'] transition-all relative before:absolute before:right-0 px-5 text-[12px] odd:bg-[#F9F9F9] w-full py-2 font-medium hover:shadow-md hover:shadow-[#C6DBFF] rounded  hover:text-[#0049C6]  hover:bg-[#C6DBFF] line leading-7">
            <a href="https://www.google.com/">
              راهبردهایی برای رفع ناترازی گاز در ایران
